...
Source0  : https://files.pythonhosted.org/packages/24/12/e8fe851bdaecfd99f7a9054cda020a4d3984318559ba2fa193cc526a238f/Pyomo-6.7.1.tar.gz
...
%prep
%setup -q -n Pyomo-6.7.1
cd %{_builddir}/Pyomo-6.7.1
pushd ..
cp -a Pyomo-6.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708627700
