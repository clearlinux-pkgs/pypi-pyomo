...
Version  : 6.4.1
Release  : 3
URL      : https://files.pythonhosted.org/packages/57/e1/0314a85b62538a78bbad3ba68807fc015f1d42ad0732af434dc6b87621ca/Pyomo-6.4.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/57/e1/0314a85b62538a78bbad3ba68807fc015f1d42ad0732af434dc6b87621ca/Pyomo-6.4.1.tar.gz
...
%prep
%setup -q -n Pyomo-6.4.1
cd %{_builddir}/Pyomo-6.4.1
pushd ..
cp -a Pyomo-6.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659487238
...
cp %{_builddir}/Pyomo-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-pyomo/a0074817440e469e323acf59316895a2a52fc14c
...
/usr/share/package-licenses/pypi-pyomo/a0074817440e469e323acf59316895a2a52fc14c
